...
class ContentHandler:
    def __init__(self):
        self.topics = [] #list of topics - TODO: Fill in the list of topics
        self.previous_topic = None
        self.current_topic = None
        self.user_input = None #parsing user input
        self.content = None #current content TODO: Connect to the knowledge
    ...
    def set_previous_topic(self, previous_topic):
